...
#define ARCH_SPIN_LOCK_LOCKED	1

#define __ARCH_SPIN_LOCK_UNLOCKED	{ ARCH_SPIN_LOCK_UNLOCKED }
...
#define __ARCH_RW_LOCK_UNLOCKED		{ __ARCH_SPIN_LOCK_UNLOCKED, RW_LOCK_BIAS }

...
#define bitops_lock(flags)   _atomic_spin_lock_irqsave(smp_bitops_lock, flags)
#define bitops_unlock(flags) _atomic_spin_unlock_irqrestore(smp_bitops_lock, flags)

...
/* Each HBP in design represented by value, control and mask triple */
#define hbp_to_ap_offset(i) (i * 3)
...
static int get_num_hbps(void)
{
	...
	/* TODO: 4, 5 and 6 do not support watchpoints */
		...
		struct pt_regs *regs)
{
	...
	unsigned int offset = hbp_to_ap_offset(dr_num);
